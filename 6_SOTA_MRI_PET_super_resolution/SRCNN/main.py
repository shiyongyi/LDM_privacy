...
if __name__ == "__main__":
    ...
    parser.add_argument('--saved_path', type=str, default=os.path.join('..', '..', 'data', 'ori_ls')) # orginal: ori_ls; synthetic: syn_ls; Test: test_ls
    
    parser.add_argument('--save_path', type=str, default=os.path.join('.','save'))
    parser.add_argument('--test_patient', type=str, default='')
    ...
    parser.add_argument('--test_iters', type=str, default=os.path.join('..', '..', 'weights', 'SRCNN', 'ori', 'last.ckpt')) # pre-trained checkpoint 
