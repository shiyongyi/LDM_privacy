...
if __name__ == "__main__":
    ...
    parser.add_argument('--saved_path', type=str, default=os.path.join('..', '..', 'data', 'test_ldct')) # orginal: ori_ldct; synthetic: syn_ldct; Test: test_ldct
    ...
    parser.add_argument('--test_iters', type=str, default=os.path.join('..', '..', 'weights', 'FBPConvNet', 'syn', 'last.ckpt')) # pre-trained checkpoint 
